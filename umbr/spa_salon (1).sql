...
--
-- Хост: MySQL-8.2
-- Время создания: Мар 18 2026 г., 12:57
...
(1, 'Андроид Андроидович', 'Главный врач, терапевт', NULL, NULL, 1, 1),
(2, 'Пулемет Калашевич', 'Врач-диетолог', NULL, NULL, 2, 1),
(3, 'Зайцев Волк', 'СПА-терапевт', NULL, NULL, 3, 1),
(4, 'Ядерный Гуль', 'Психолог', NULL, NULL, 4, 1);
